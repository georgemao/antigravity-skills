...
| :--- | :--- | :--- | :--- |
| [**AI Developer**](./ai-developer/SKILL.md) | Automates code check-ins to GitHub by reviewing code, suggesting improvements, creating Pull Requests, and merging them. | GitHub MCP | Only reviews source code files against the main branch (excluding documentation, configuration, and package files). |
